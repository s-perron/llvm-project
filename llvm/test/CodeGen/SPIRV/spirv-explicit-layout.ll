...
define void @private_load() #1 {
entry:
  %i = alloca %struct.S, align 4
  %1 = load %struct.S, ptr addrspace(10) @private, align 4
  store %struct.S %1, ptr %i, align 4
  ret void
}

define void @storage_buffer_load() #1 {
entry:
  %i = alloca %struct.S, align 4
  %1 = load %struct.S, ptr addrspace(11) @storage_buffer, align 4
  store %struct.S %1, ptr addrspace(10) @private, align 4
  ret void
}

define void @vulkan_buffer_load() #1 {
entry:
